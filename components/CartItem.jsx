...
const CartItem = () => {
  return (
    <div className='flex py-5 gap-3 md:gap-5 border-b'>
      {/* // Image Start */}
        <div className='shrink-0 aspect-square w-[50px] md:w-[121-px]'>
              ...
              <div className='flex item-center gap-1'>
                <div className='font-semibold'>Size:</div>
                  <select className='hover:text-black'>
                    ...
                    <option value="12">UK 11.5</option>
                    <option value="13">UK 12</option>
                    <option value="14">UK 12.5</option>
                    <option value="15">UK 13</option>
                  </select>
              </div>
